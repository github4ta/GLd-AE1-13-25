...
public class HomePage {
    ...
    private final String FOOTER_LINK_FOR_SUPPLIERS =
            "//a[@href='https://emall.by/information/company/conditions-for-selecting-a-counterparty']";

    private final String contactsLink = "//a[@title='Контакты']";
    private final String LINK_LOGIN = "//a[@href='https://emall.by/login?backurl=/']";
    private final String LINK_USER_AGREEMENT = "//a[@href='https://api-preprod.emall.by/649008c9c6277_publichnyj-dogovor-emall.pdf']";
